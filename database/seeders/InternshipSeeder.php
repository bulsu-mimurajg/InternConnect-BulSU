...
class InternshipSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $internshipData = [
            ...
            [
                'h_t_e_id' => $htes->where('company_name', 'TechCorp Solutions')->first()->id,
            ...
            [
                'h_t_e_id' => $htes->where('company_name', 'DataFlow Analytics')->first()->id,
            ...
            [
                'h_t_e_id' => $htes->where('company_name', 'GreenTech Industries')->first()->id,
            ...
            [
                'h_t_e_id' => $htes->where('company_name', 'Creative Marketing Pro')->first()->id,
            ...
            [
                'h_t_e_id' => $htes->where('company_name', 'FinanceFirst Bank')->first()->id,
