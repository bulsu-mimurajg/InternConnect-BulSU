...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Commented out: Manual student creation - using SingleUnassessedStudentSeeder instead
        ...
        // Seed student assessment questions (multiple choice with answers)
        $this->call(StudentAssessmentQuestionsSeeder::class);
        $this->call(SectionSeeder::class);

        // Commented out: Clairo student creation - using SingleUnassessedStudentSeeder instead
        ...
        // Commented out: George Miller (unverified student) creation - using SingleUnassessedStudentSeeder instead
        ...
        // Commented out: Multiple student seeders - using SingleUnassessedStudentSeeder for testing instead
        // $this->call(StudentSeeder::class);
        // $this->call(ExtendedStudentSeeder::class);

        // Create only one unassessed test student and HTE
        $this->call(SingleUnassessedStudentSeeder::class);

        $this->call(AcademeAccountSeeder::class);
        $this->call(InternshipCriteriaSeeder::class);

        // Commented out: Student scores and matches - unassessed student doesn't have these yet
...
//        $this->call(UnplacedStudentDemoSeeder::class);
        ...
        // Commented out: Creates 5 additional test students - keep only the unassessed student
