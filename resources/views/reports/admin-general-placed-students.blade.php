...
<head>
    ...
    <title>Placed Students Report - All Sections</title>
    <style>
        body { 
    ...
    <div class="container">
        ...
        <div class="content-wrapper">
            <div class="report-title">
                <h1>Placed Students Report - All Sections</h1>
            </div>
            ...
            <!-- All Placed Students Details -->
            @if(isset($placedStudents) && count($placedStudents) > 0)
            <div class="section page-break">
                <h2>All Placed Students Details</h2>
                <div class="section-content">
                    <table>
                        <thead>
                            <tr>
            ...
            <div class="section page-break">
                ...
                <div class="section-content">
                    <div class="stats">
                        <p style="text-align: center; color: #6c757d; font-style: italic;">No placed students found in the system.</p>
                    </div>
                </div>
            </div>
            @endif
