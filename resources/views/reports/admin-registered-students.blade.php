...
<head>
    <meta charset="utf-8">
    <title>Registered Students Report - {{ $sectionName }}</title>
    <style>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th class="col-verified">Is Verified</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td class="col-date">{{ $student['registered_at'] }}</td>
                <td class="col-verified">{{ $student['is_verified'] ? 'Yes' : 'No' }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
    @else
    <p>No registered students found for this section.</p>
    @endif
