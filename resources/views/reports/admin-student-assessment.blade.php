...
<body>
    <div class="container">
        ...
        <div class="content-wrapper">
            ...
            <div class="section">
                <h2>Section Assessment Statistics</h2>
                        ...
                        <div class="metric-group">
                            ...
                            <table style="width: 100%; border-collapse: separate; border-spacing: 15px;">
                                <tr>
                                    ...
                                    <td style="width: 25%; vertical-align: top;">
                                        <div class="stat-item">
                                            <div class="stat-value">{{ $overviewStats['pendingAssessments'] }}</div>
                        ...
                        <div class="metric-group">
                            ...
                            <table style="width: 100%; border-collapse: separate; border-spacing: 15px;">
                                <tr>
                                    ...
                                    <td style="width: 33.33%; vertical-align: top;">
                                        <div class="stat-item">
                                            <div class="stat-value">{{ $overviewStats['highestScore'] }}</div>
                                            <div class="stat-label">Highest Score</div>
                                        </div>
                                    </td>
                                    <td style="width: 33.33%; vertical-align: top;">
                                        <div class="stat-item">
                                            <div class="stat-value">{{ $overviewStats['lowestScore'] }}</div>
